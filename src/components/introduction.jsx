                ...
                <div className="container-fluid">
                  <div className="row">
                    <div className="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                      <div className="slider-text-inner">
                        <div className="desc">
                          <h1>I love Sharing<br /> KNOWLEDGE !!</h1>
                          <p><a className="btn btn-primary btn-learn" href="https://great-stegosaurus-fdca3.netlify.com/" target="_blank" rel="noopener noreferrer">View blog <i className="icon-briefcase3" /></a></p>
                        </div>
                      </div>
                    </div>
                  </div>
