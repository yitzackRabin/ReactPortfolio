                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        ...
                        <p>I am a freelance developer majoring in Android and web Backend development.
                          I am also exploring the role of container technology like Docker and container-orchrastation
                          technologies like K8s, Swarm to create industry standard production environments.</p>
                      </div>
                    </div>
                  </article>
                    ...
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        ...
                        <p>I am pursuing my under-graduate studies with major in Computer Science.
                          ...
                          been part of S.D.G.(Student Developer Group).</p>
                      </div>
                    </div>
                  </article>
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
